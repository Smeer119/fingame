...
const COLORS: Record<string, string> = {
  ...
  income: "oklch(0.42 0.15 154)",
  other: "oklch(0.7 0.05 0)",
}

export default function CategoricalAnalysis({ transactions }: { transactions: Transaction[] }) {
    ...
    <Card className="border border-border">
      ...
      <CardContent>
        {categoryData.length === 0 ? (
          <div className="h-64 flex items-center justify-center text-muted-foreground">No category data</div>
        ) : (
